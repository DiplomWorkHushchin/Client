...
export default function SelectCourseImgBlock({ onImageSelect, selectedFile }: UploadImgBlockProps) {
    ...
    return (
        <div
            className="p-4 flex flex-col gap-4 items-center border-dashed border-2 rounded-lg"
